...
const QString BITCOIN_IPC_PREFIX("electron:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click electron: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start electron: click-to-pay handler");
    else
...
{
    // clicking on electron: URLs creates FileOpen events on the Mac:
