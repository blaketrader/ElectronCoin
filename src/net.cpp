...
static const char *strMainNetDNSSeed[][2] = {
    {"electron-coin.com", "electron-coin.com"},
	{"s1.electron-coin.com", "s1.electron-coin.com"},
	{"s2.electron-coin.com", "s2.electron-coin.com"},
...
static const char *strTestNetDNSSeed[][2] = {
	{"test1.electron-coin.com", "test1.electron-coin.com"},
	{"test2.electron-coin.com", "test2.electron-coin.com"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Electron is probably already running."), addrBind.ToString().c_str());
        else
