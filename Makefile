#############################################################################
# Makefile for building: electron-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: ter set 22 12:13:06 2020
# Project:  Electron-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile Electron-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DMINIUPNP_STATICLIB -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -IC:/deps/miniupnpc -Isrc/leveldb/include -Isrc/leveldb/helpers -IC:/deps/boost_1_71_0 -IC:/deps/db-4.8.30.NC/build_unix -IC:/deps/openssl-1.0.2n/include -IC:/deps/qrencode-3.4.4 -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -LC:/deps/miniupnpc -lminiupnpc /home/luis/Desktop/ElectronCoin/src/leveldb/libleveldb.a /home/luis/Desktop/ElectronCoin/src/leveldb/libmemenv.a -lrt -LC:/deps/boost_1_71_0/stage/lib -LC:/deps/db-4.8.30.NC/build_unix -LC:/deps/openssl-1.0.2n -LC:/deps/qrencode-3.4.4/.libs -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lboost_chrono -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/blake.c build/moc_bitcoingui.cpp \
...
$(TARGET): /home/luis/Desktop/ElectronCoin/src/leveldb/libleveldb.a /home/luis/Desktop/ElectronCoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Electron-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile Electron-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/electron-qt0.8.9.8 || $(MKDIR) build/electron-qt0.8.9.8 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/electron-qt0.8.9.8/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_uk.ts build/electron-qt0.8.9.8/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/auxpow.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/sph_blake.h src/sph_types.h build/electron-qt0.8.9.8/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/electron-qt0.8.9.8/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/auxpow.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/blake.c build/electron-qt0.8.9.8/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/electron-qt0.8.9.8/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_uk.ts build/electron-qt0.8.9.8/ && (cd `dirname build/electron-qt0.8.9.8` && $(TAR) electron-qt0.8.9.8.tar electron-qt0.8.9.8 && $(COMPRESS) electron-qt0.8.9.8.tar) && $(MOVE) `dirname build/electron-qt0.8.9.8`/electron-qt0.8.9.8.tar.gz . && $(DEL_FILE) -r build/electron-qt0.8.9.8


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/luis/Desktop/ElectronCoin/src/leveldb/libleveldb.a; cd /home/luis/Desktop/ElectronCoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/luis/Desktop/ElectronCoin/src/leveldb/libleveldb.a: FORCE
	cd /home/luis/Desktop/ElectronCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/luis/Desktop/ElectronCoin/build/build.h: FORCE
	cd /home/luis/Desktop/ElectronCoin; /bin/sh share/genbuild.sh /home/luis/Desktop/ElectronCoin/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/bitcoin_gu_IN.qm src/qt/locale/bitcoin_hi_IN.qm src/qt/locale/bitcoin_lv_LV.qm src/qt/locale/bitcoin_th_TH.qm src/qt/locale/bitcoin_uk.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/bitcoin_gu_IN.qm src/qt/locale/bitcoin_hi_IN.qm src/qt/locale/bitcoin_lv_LV.qm src/qt/locale/bitcoin_th_TH.qm src/qt/locale/bitcoin_uk.qm
